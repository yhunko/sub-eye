# Paddle Webhooks - Next.js Example

Minimal example of receiving Paddle webhooks with signature verification using Next.js App Router.
...
3. Add your Paddle webhook secret to `.env.local`
