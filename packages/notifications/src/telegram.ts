...
/**
 * Telegram Bot API transport. Pure HTTP + env-based configuration — no database
 * or domain dependencies. Domain orchestration (link payloads, preferences,
 * message templates) lives in the server's telegram-notification domain.
 */
