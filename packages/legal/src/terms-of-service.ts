      ...
      blocks: [
        ...
        },
        {
          p: [
            ...
            ", or the equivalent set for your App Store storefront — about 199\u00a0₴ in Ukraine. It is not a subscription and it does not renew. It unlocks control over when reminders land, trial-ending reminders, the price history on each subscription, categories with their filter and the spend breakdown, the year view and the month-on-month figures inside the calendar, and the Home Screen widgets.",
          ],
        },
        {
          p: [
